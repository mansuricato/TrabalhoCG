...
def Cube():
    ...
    cube_faces[1] = Polygon([Point(1.0, 1.0, -1.0), Point(-1.0, 1.0, 1.0), Point(-1.0, 1.0, 1.0), Point(1.0, 1.0, 1.0)])
    ...
    cube_faces[2] = Polygon([Point(1.0, -1.0, 1.0), Point(-1.0, -1.0, 1.0), Point(-1.0, -1.0, -1.0), Point(1.0, -1.0, -1.0)])
    ...
    cube_faces[3] = Polygon([Point(1.0, 1.0, 1.0), Point(-1.0, 1.0, 1.0), Point(-1.0, -1.0, 1.0), Point(1.0, -1.0, 1.0)])
    ...
    cube_faces[4] = Polygon([Point(1.0, -1.0, -1.0), Point(-1.0, -1.0, -1.0), Point(-1.0, 1.0, -1.0), Point(1.0, 1.0, -1.0)])
    ...
    cube_faces[5] = Polygon([Point(-1.0, 1.0, 1.0), Point(-1.0, 1.0, -1.0), Point(-1.0, -1.0, -1.0), Point(-1.0, -1.0, 1.0)])
    ...
    cube_faces[6] = Polygon([Point(1.0, 1.0, -1.0), Point(1.0, 1.0, 1.0), Point(1.0, -1.0, 1.0), Point(1.0, -1.0, -1.0)])
