...
class Polygon(object):
    ...
    def __init__(self, points, color = None, transform = numpy.matrix(numpy.identity(4)), transAngle=0, transPoint=None, transAxis=None, transMaxAngle=None, transParent=None):
